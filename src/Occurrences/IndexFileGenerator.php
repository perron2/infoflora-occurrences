        ...
        if ($withStatistics) {
            foreach ($sectors as $sector) {
                ...
                if ($sector->occurrencesPotential > 0) {
                    $sector->progressLast5Years = round($sector->occurrencesLast5Years * 100.0 / $sector->occurrencesPotential);
                    $sector->progressLast10Years = round($sector->occurrencesLast10Years * 100.0 / $sector->occurrencesPotential);
                    $sector->progressLast20Years = round($sector->occurrencesLast20Years * 100.0 / $sector->occurrencesPotential);
                }
            }
        }
        return $sectors;
